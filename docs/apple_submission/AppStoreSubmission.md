...
Use this template to keep all information and assets needed for App Store Connect in one place. Fill in the fields before submitting a new build.
...
- https://www.thespartan.app/support.html

### Marketing URL (optional)

- https://www.thespartan.app/
...
- `screenshots/`: iPhone, iPad, and watch screenshots exported at required sizes.
- `app_previews/`: App preview or clip videos in the formats accepted by App Store Connect.
- `marketing_assets/`: Icons, feature graphics, or promotional artwork referenced in the listing.
- `review_support/`: Other supporting files (Routing coverage, review attachments, release notes).

Ensure each asset is clearly named with device/locale/build info as needed.
...
- List any files dropped into `review_support/` that should be uploaded in App Store Connect:
  - 

## Release Options

Select the desired release option on App Store Connect and record it here for the team:

- [ ] Manually release this version
- [ ] Automatically release this version
- [ ] Automatically release after App Review, no earlier than: ____

## Submission Checklist

- [ ] All text fields above are final and proofread.
- [ ] Screenshots and previews exported and stored in their folders.
- [ ] Required attachments added to `review_support/`.
- [ ] Sign-in credentials verified on the latest build.
- [ ] Contact information confirmed.
- [ ] Release option agreed upon by the team.
