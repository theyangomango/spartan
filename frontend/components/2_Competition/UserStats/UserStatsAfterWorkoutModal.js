...
const styles = StyleSheet.create({
  ...
  handle: { fontSize:ss(16), fontFamily:'Outfit_600SemiBold', color:'#0F172A' },
  subHandle: { marginTop:ss(2), fontSize:ss(11), fontFamily:'Outfit_400Regular', color:'#64748B' },
  scorePill: { flexDirection:'row', alignItems:'baseline', paddingHorizontal:ss(10), paddingVertical:ss(6), borderRadius:ss(999), borderWidth:1, borderColor:'#E6EEF6', backgroundColor:'#fff' },
  scorePillLabel: { fontSize:ss(10), fontFamily:'Outfit_600SemiBold', color:'#64748B', marginRight:ss(6), letterSpacing:0.6 },
  ...
  separator: { height: StyleSheet.hairlineWidth, backgroundColor:'rgba(2,6,23,0.08)', marginTop:ss(12), marginBottom:ss(8), marginHorizontal:-ss(18) },
  grid: { flexDirection:'row', flexWrap:'wrap', justifyContent:'space-between', marginTop:ss(2), marginBottom:ss(10) },
  tile: { width:'48%', backgroundColor:'#F8FAFC', borderRadius:ss(14), paddingVertical:ss(10), paddingHorizontal:ss(12), marginBottom:ss(10), borderWidth:StyleSheet.hairlineWidth, borderColor:'rgba(100,116,139,0.12)' },
  tileLabel: { fontFamily:'Outfit_600SemiBold', fontSize:ss(13), color:'#0F172A' },
