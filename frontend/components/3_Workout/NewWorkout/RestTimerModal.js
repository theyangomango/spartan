...
const styles = StyleSheet.create({
    ...
    card: {
        ...
        padding: scaleSize(scaledSize(18)),
        alignItems: "center",
    ...
    handle: {
        width: scaleSize(scaledSize(38)),
        height: scaleSize(scaledSize(4)),
        borderRadius: scaleSize(scaledSize(2)),
        backgroundColor: theme.hairline,
        marginBottom: scaleSize(scaledSize(10)),
    },
    closeBtn: {
        position: "absolute",
        top: scaleSize(scaledSize(10)),
        right: scaleSize(scaledSize(10)),
    ...
    closeTxt: {
        ...
        lineHeight: scaleSize(scaledSize(22)),
    ...
    ghostBtn: {
        flex: 1,
        paddingVertical: scaleSize(scaledSize(11)),
        borderRadius: scaleSize(scaledSize(12)),
        backgroundColor: theme.addBtnBg,
        alignItems: "center",
        justifyContent: "center",
