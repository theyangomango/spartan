            ...
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <View style={styles.headerContent}>
                        ...
                        <Text style={styles.handleText}>YourHandle</Text>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    header: {
        ...
        paddingTop: Platform.OS === 'ios' ? 40 : 30, // Increased header height
    ...
    inputContainer: {
        ...
        paddingHorizontal: 20,
        paddingVertical: 10,
        paddingBottom: Platform.OS === 'ios' ? 20 : 10, // Add padding to the bottom
    },
    textInput: {
        flex: 1,
        borderColor: '#ccc',
